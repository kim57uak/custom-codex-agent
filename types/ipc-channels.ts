...
export const IPC_CHANNELS = {
  invoke: {
    ...
    'workflow:agent-profiles': 'workflow:agent-profiles',
    'workflow:recommend-and-create': 'workflow:recommend-and-create',
    'workflow:retry': 'workflow:retry',
    'workflow:retry-step': 'workflow:retry-step',
    'workflow:permission-respond': 'workflow:permission-respond',
    'workflow:skip-step': 'workflow:skip-step',
    'workflow:add-step': 'workflow:add-step',
    'workflow:remove-step': 'workflow:remove-step',
    'workflow:update-step-prompt': 'workflow:update-step-prompt',
    'workflow:create-run': 'workflow:create-run',
    'workflow:events': 'workflow:events',
    'workflow:run-detail': 'workflow:run-detail',
    'workflow:delete-run': 'workflow:delete-run',
    ...
    'settings:set-default-engine': 'settings:set-default-engine',
  },
  send: {
  ...
  on: {
    ...
    'workflow:permission-request': 'workflow:permission-request',
  },
} as const;
